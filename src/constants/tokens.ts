...
const tokens: Record<string, Token> = {
  // FOXLAYER should always be first token for GLAYER calculation
  foxlayer: {
    symbol: 'FOXLAYER',
    address: {
      [ChainId.BSC]: '0x84a5A0CaB56def6aDAf8Cd591630fEE8FEC6a2f5',
      [ChainId.MATIC]: '0x5d47baba0d66083c52009271faf3f50dcc01023c',
      [ChainId.MAINNET]: '0x84a5A0CaB56def6aDAf8Cd591630fEE8FEC6a2f5',
