...
const vaults: VaultConfig[] = [
  {
    ...
    masterchef: {
      ...
      address: {
        [ChainId.BSC]: '0x19d1F73a59dcE256d1083C3103DD2415678BdCa8',
      },
      rewardsPerBlock: {
  ...
  },
  {
    ...
    stakeToken: tokens.foxlayerBnb,
    token: tokens.foxlayer,
    quoteToken: tokens.wbnb,
    rewardToken: tokens.foxlayerBnb,
    platform: 'ApeSwap',
    masterchef: {
      pid: {
        [ChainId.BSC]: 1,
  ...
  // FOXLAYER - BUSD Vault config
  {
    ...
    stakeToken: tokens.foxlayerBusd,
    token: tokens.foxlayer,
    quoteToken: tokens.busd,
    rewardToken: tokens.foxlayerBusd,
    platform: 'ApeSwap',
    masterchef: {
      pid: {
        [ChainId.BSC]: 2,
